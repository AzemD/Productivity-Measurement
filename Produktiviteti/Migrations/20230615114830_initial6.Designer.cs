...
namespace Produktiviteti.Migrations
{
    ...
    [Migration("20230615114830_initial6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Produktiviteti.Models.MainTableViewModel", b =>
                {
                    b.Property<int>("Main_Table_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Tipi_KerkesesKerkesaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Tipi_KerkesesKerkesaId");

                    b.HasIndex("userId");

                    b.ToTable("MainTableViewModel");
                });
            ...
            modelBuilder.Entity("Produktiviteti.Models.MainTableViewModel", b =>
                {
                    b.HasOne("Produktiviteti.Models.Tipi_Kerkeses", "Tipi_Kerkeses")
                        .WithMany()
                        .HasForeignKey("Tipi_KerkesesKerkesaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
